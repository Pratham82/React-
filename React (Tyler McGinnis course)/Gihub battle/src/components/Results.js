			...
			<div className="grid container-sm space-around">
				<div className="card bg-light">
					...
					<ul className="card-list">
						...
						{winner.profile.location && (
							<li>
								<FaCompass color="rgba(144,115,25)" size={22} />
								{winner.profile.location}
							</li>
						)}
						...
						<li>
							<FaUsers color="rgba(129,195,95)" size={22} />
							{winner.profile.followers.toLocaleString()} follower
						</li>
						<li>
							<FaUserFriends color="rgba(64,183,245)" size={22} />
				...
				<div className="card bg-light">
					...
					<ul className="card-list">
						...
						<li>
							<FaUsers color="rgba(129,195,95)" size={22} />
							{loser.profile.followers.toLocaleString()} follower
						</li>
						<li>
							<FaUserFriends color="rgba(64,183,245)" size={22} />
